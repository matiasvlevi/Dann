  ...
  suite('Activation functions', function () {
    suite('sigmoid', function () {
      ...
      test("Testing 'sigmoid_d' activation function", function () {
        ...
        for (let i = 0; i < pointsX.length; i++) {
          assert.closeTo(
            activations.sigmoid_d(pointsX[i]),
            ans_hardcoded[i],
            0.01
          );
        }
    ...
    suite('sinc', function () {
      test("Testing 'sinc' activation function", function () {
        ...
        for (let i = 0; i < pointsX.length; i++) {
          assert.closeTo(activations.sinc(pointsX[i]), ans_hardcoded[i], 0.01);
        }
      });
    ...
    suite('softsign', function () {
      test("Testing 'sinc' activation function", function () {
        ...
        for (let i = 0; i < pointsX.length; i++) {
          assert.closeTo(
            activations.softsign(pointsX[i]),
            ans_hardcoded[i],
            0.01
          );
        }
      ...
      test("Testing 'softsign_d' activation function", function () {
        ...
        for (let i = 0; i < pointsX.length; i++) {
          assert.closeTo(
            activations.softsign_d(pointsX[i]),
            ans_hardcoded[i],
            0.01
          );
        }
    ...
    suite('binary', function () {
      ...
      test("Testing 'binary_d' activation function", function () {
        ...
        for (let i = 0; i < pointsX.length; i++) {
          assert.closeTo(
            activations.binary_d(pointsX[i]),
            ans_hardcoded[i],
            0.01
          );
        }
    ...
    suite('softplus', function () {
      test("Testing 'softplus' activation function", function () {
        ...
        for (let i = 0; i < pointsX.length; i++) {
          assert.closeTo(
            activations.softplus(pointsX[i]),
            ans_hardcoded[i],
            0.01
          );
        }
      ...
      test("Testing 'softplus_d' activation function", function () {
        ...
        for (let i = 0; i < pointsX.length; i++) {
          assert.closeTo(
            activations.softplus_d(pointsX[i]),
            ans_hardcoded[i],
            0.01
          );
        }
