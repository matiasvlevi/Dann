...
<p align="center">
    Train a eural network with your dataset & save it's trained state!
...
<p align="center">
  ...
  <a href="https://discord.gg/8yBTnBVf">Contribute</a> •
  <a href="https://github.com/matiasvlevi/Dann/blob/master/CONTRIBUTING.md">Discord</a> •
...
### CDN :
```html
<script src="https://cdn.jsdelivr.net/gh/matiasvlevi/dann@v2.2.3d/build/dann.min.js"></script>
```
### Node :
```
npm i dannjs
