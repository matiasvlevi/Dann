...
### CDN :
```html
<script src="https://cdn.jsdelivr.net/gh/matiasvlevi/dann@v2.4.1b/build/dann.min.js"></script>
```
### Node :
```
npm i dannjs
...
<table>
  ...
  <tr>
    <td align="center"><a href="https://github.com/and1can"><img src="https://avatars.githubusercontent.com/u/7698330?v=4?s=100" width="100px;" alt=""/><br /><sub><b>and1can</b></sub></a><br /><a href="https://github.com/matiasvlevi/Dann/commits?author=and1can" title="Code">💻</a> <a href="https://github.com/matiasvlevi/Dann/commits?author=and1can" title="Tests">⚠️</a></td>
  </tr>
</table>
